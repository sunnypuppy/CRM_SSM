			...
			<div class="panel panel-default">
				...
				<!--综合查询条件  -->
					<form class="form-inline"
						action="${pageContext.request.contextPath }/cust/list" method="post">
						<div class="form-group">
							<label for="customerName">客户名称</label> 
							<input type="text" id="customerName" name="custName" value="${queryVo.custName}" class="form-control"/>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<select id="custIndustry" name="custIndustry" class="form-control">
								...
								<c:forEach items="${industryType}" var="item">
									<option value="${item.dictId}"
										<c:if test="${item.dictId == queryVo.custIndustry}"> selected</c:if>>
										${item.dictItemName}
									</option>
								</c:forEach>
							</select>
						...
						<div class="form-group">
							...
							<select id="custLevel" name="custLevel" class="form-control">
								...
								<c:forEach items="${levelType}" var="item">
									<option value="${item.dictId}"
										<c:if test="${item.dictId == queryVo.custLevel}"> selected</c:if>>
										${item.dictItemName}
									</option>
								</c:forEach>
							</select>
